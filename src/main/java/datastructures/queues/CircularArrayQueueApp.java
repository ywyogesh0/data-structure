...
public class CircularArrayQueueApp {
    ...
    public static void main(String[] args) {
        CircularArrayQueueApp circularArrayQueueApp = new CircularArrayQueueApp();

        circularArrayQueueApp.runIntegerArrayQueue();
        System.out.println("\n**********************************************\n");
    }

    private void runIntegerArrayQueue() {
        ADTQueue<Integer> adtQueue = new CircularArrayQueue<>();
